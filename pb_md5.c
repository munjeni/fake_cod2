...
void MD5Init (PB_MD5_CTX *mdContext, unsigned long pseudoRandomNumber )
{
...
void MD5Update (PB_MD5_CTX *mdContext, unsigned char *inBuf, unsigned int inLen)
{
  UINT4 in[16];
  int mdi;
  unsigned int i, ii;
...
void MD5Final (PB_MD5_CTX *mdContext)
{
  UINT4 in[16];
  int mdi;
  unsigned int i, ii;
